...
\newglossarystyle{long-cz-acronyms}{%
 \setglossarystyle{long-name-desc}% 
...
% Citations
\usepackage[backend=biber,style=iso-numeric,citestyle=numeric-comp,maxbibnames=5,minbibnames=5]{biblatex}
...
\section*{Abstrakt}
\subsection*{\nazev:}
\input{chapters/abstract/abstract_cs.tex}
...
\section*{Abstract}
\subsection*{\nazevENG:}
\input{chapters/abstract/abstract_en.tex}
...
\input{chapters/02_prehled_soucasneho_stavu}
\clearpage

\chapter{Cíle práce}
\input{chapters/03_cile_prace}
\clearpage

\chapter{Metody}
\input{chapters/04_metody}
\clearpage

\chapter{Výsledky}
\input{chapters/05_vysledky}
\clearpage

\chapter{Diskuse}
\input{chapters/06_diskuse}
\clearpage
