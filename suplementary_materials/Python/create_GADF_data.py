...
def create_gadf_map(data, image_size, method="difference"):
...
def create_gadf_data(file, out_dir, n):
    logging.info(f"Creating GADF dataset for {file.split('/')[2]}")
    ...
    with open(out_dir + "GADF_" + file.split("/")[2], "wb") as f:
...
if __name__ == "__main__":
    ...
    CLAS_file = "data/merged/CLAS_merged_5s.pkl"
    WESAD_file = "data/merged/WESAD_merged_1s.pkl"
    out_dir = "data/GADF_Data/"
    shape = 32
